...
# Define el cromosoma de interés (cambia este valor si quieres otro)
chr=22

echo "Descargando datos para el cromosoma ${chr}"

# Archivos del cromosoma específico
...
# Archivos de referencia y panel (comunes a todos los cromosomas)
...
echo "Descarga completada para el cromosoma ${chr}"